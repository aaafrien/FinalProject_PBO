 ...
 * @author Afrien
 */
public class PengembalianMobil_Controller {
    Rent_Model rent_Model;
    Pengembalian_View pengembalian_View;

    public PengembalianMobil_Controller(Rent_Model rent_Model, Pengembalian_View pengembalian_View) {
        ...
        pengembalian_View.btKembalikan().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                rent_Model.kembalikanMobil(merk, plat, harga, id);
