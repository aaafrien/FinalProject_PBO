 ...
 * @author Afrien
 */
public class SewaMotor_Controller {
    Rent_Model rent_Model;
    DetailSewa_View detailSewa_View;

    public SewaMotor_Controller(Rent_Model rent_Model, DetailSewa_View detailSewa_View) {
        ...
        detailSewa_View.btSewa().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent arg0) {
                ...
                rent_Model.sewaMotor(merk, plat, harga, tgl_sewa, tgl_kembali, id);
